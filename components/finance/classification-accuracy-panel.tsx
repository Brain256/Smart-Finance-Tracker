  ...
  return (
    <section className="dashboard-card p-4">
      <div className="mb-4 flex items-start justify-between gap-3">
        <div>
          <h2 className="text-base font-semibold tracking-normal text-[var(--foreground)]">Classification accuracy</h2>
      ...
      {accuracy.status === "unavailable" ? (
        ...
        <div>
          <p className="text-2xl font-semibold tracking-normal text-[var(--foreground)] sm:text-3xl">
